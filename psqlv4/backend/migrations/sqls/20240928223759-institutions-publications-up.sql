...
INSERT INTO institutions_publications (institution_id, publication_id) VALUES
  ((SELECT institution_id FROM institutions WHERE institution_name = 'Smithsonian Institution'), (SELECT publication_id FROM publications WHERE title = 'The Social Structure of Penguin Colonies'));
