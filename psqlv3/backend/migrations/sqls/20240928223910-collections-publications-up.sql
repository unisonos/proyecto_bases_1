...
INSERT INTO collections_publications (collection, publication) VALUES
  ((SELECT collection_id FROM collections WHERE collection_name = 'Jungle'), (SELECT publication_id FROM publications WHERE title = 'The World of Warcraft')),
  ((SELECT collection_id FROM collections WHERE collection_name = 'Tundra'), (SELECT publication_id FROM publications WHERE title = 'The World of Warcraft'));
;
