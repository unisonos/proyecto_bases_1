...
INSERT INTO species_publications (species_id, publication_id) VALUES
  ((SELECT species_id FROM species WHERE species_name = 'silvestris catus'), (SELECT publication_id FROM publications WHERE title = 'The World of Warcraft')),
  ((SELECT species_id FROM species WHERE species_name = 'chaus chaus'), (SELECT publication_id FROM publications WHERE title = 'The World of Warcraft')),
  ...
  ((SELECT species_id FROM species WHERE species_name = 'chaus affinis'), (SELECT publication_id FROM publications WHERE title = 'Whisker Development in Feline Species')),
